...
public class readFile implements IStmt{
    ...
    public MyIDictionary<String, IType> typecheck(MyIDictionary<String, IType> typeEnv) throws MyExceptions {
        ...
        {
            if (typeEnv.lookup(varName).equal(new IntType()))
                return typeEnv;
            else throw new MyExceptions("readFile requires an int as its variable parameter");
        }
        else throw new MyExceptions("readFile requires a string as an expression parameter");
    }
