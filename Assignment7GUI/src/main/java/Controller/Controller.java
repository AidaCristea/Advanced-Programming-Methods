...
public class Controller {
    ...
    public void oneStepForAllPrg(List<PrgState> prgList) throws MyExceptions, IOException, InterruptedException {
        prgList.forEach(prg -> {
            try
            {
    ...
    public void oneStep() throws MyExceptions, IOException, InterruptedException
    {
        executor=Executors.newFixedThreadPool(2);
        List<PrgState> prgStates = removeCompletedPrg(repo.getPrgList());
    ...
    */
    ...
    {
        this.repo.setPrgList(prgStates);
    }
